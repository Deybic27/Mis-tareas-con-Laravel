        ...
        <div class="footer__menus">
            <nav class="footer__menus_menu-1">
                ...
                <ul class="footer__menus_menu-1_list">
                    <li class="footer__menus_menu-1_list_item">Finalidad del blog</li>
                    <li class="footer__menus_menu-1_list_item">Portafolio de Deybic Rojas</li>
                    <li class="footer__menus_menu-1_list_item">Blog</li>
                    <li class="footer__menus_menu-1_list_item">Portafolio de Deybic Rojas</li>
                    <li class="footer__menus_menu-1_list_item">Portafolio de Deybic Rojas</li>
                    <li class="footer__menus_menu-1_list_item">Portafolio de Deybic Rojas   </li>
                </ul>
            ...
            <nav class="footer__menus_menu-2">
                ...
                <ul class="footer__menus_menu-2_list">
                    <li class="footer__menus_menu-2_list_item">Finalidad del blog</li>
                    <li class="footer__menus_menu-2_list_item">Portafolio de Deybic Rojas</li>
                    <li class="footer__menus_menu-2_list_item">Blog</li>
                    <li class="footer__menus_menu-2_list_item">Portafolio de Deybic Rojas</li>
                    <li class="footer__menus_menu-2_list_item">Portafolio de Deybic Rojas</li>
                    <li class="footer__menus_menu-2_list_item">Portafolio de Deybic Rojas   </li>
                </ul>
